...
describe('generatePrismaClient', () => {
  ...
  it('should execute prisma generate with DATABASE_URL', () => {
    generatePrismaClient('auth-service', 'postgresql://localhost:5432/auth');

    expect(mockExecuteCommand).toHaveBeenCalledWith(
      'DATABASE_URL="postgresql://localhost:5432/auth" npx prisma generate',
  ...
  it('should use the correct cwd from getServicePath', () => {
    ...
    generatePrismaClient('my-service', 'postgresql://localhost:5432/db');
